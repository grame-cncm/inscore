{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 67.0, 919.0, 869.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 67.0, 919.0, 869.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 121.0, 597.0, 58.0, 20.0 ],
					"id" : "obj-62",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 623.0, 95.0, 18.0 ],
					"id" : "obj-74",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 120.0, 644.5, 45.0, 20.0 ],
					"id" : "obj-82",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 60.0, 587.5, 32.5, 20.0 ],
					"id" : "obj-100",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 674.0, 110.0, 18.0 ],
					"id" : "obj-61",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 16.0, 704.5, 53.0, 20.0 ],
					"id" : "obj-55",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/ITL/scene/sync car* myGuidoFile h",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 524.0, 147.0, 200.0, 18.0 ],
					"id" : "obj-9",
					"fontname" : "Arial"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-100", 0 ],
					"hidden" : 0,
					"midpoints" : [ 93.5, 361.75, 69.5, 361.75 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-55", 0 ],
					"hidden" : 0,
					"midpoints" : [ 69.5, 655.5, 25.5, 655.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 69.5, 640.25, 25.5, 640.25 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 150.0, 619.5, 129.5, 619.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 83.0, 616.5, 106.75, 616.5, 106.75, 587.0, 130.5, 587.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 556.5, 140.0, 519.0, 140.0, 519.0, 176.0, 556.5, 176.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-55", 0 ],
					"hidden" : 0,
					"midpoints" : [ 25.5, 701.25, 25.5, 701.25 ]
				}
