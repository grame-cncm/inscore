...
\begin{tikzpicture}
  ...
  \draw[childD] (13)to[bend left](16);
  \draw[childD] (5)to[bend left](13);
  \draw[childD] (1)to[bend left](2);
  \draw[childD] (3)to[bend left](4);
  \draw[childD] (6)to[bend right](7);
  \draw[childD] (6)to[bend right](8);
  \draw[childD] (8)to[bend right](9);
  \draw[childD] (11)to[bend right](12);
\end{tikzpicture}
