...
\item \textbf{\OSC{print(val1 [, val2 [, ...]])}} : print the arguments to the OSC standard output. The arguments are prefixed by 'javascript:'. The function is provided for debug purpose.
