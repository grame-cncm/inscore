...
INScore saves its state to files containing textual OSC messages. These files can be created from scratch using any text editor. In order to provide users with a scripting language, the OSC syntax has been extended at textual level.
