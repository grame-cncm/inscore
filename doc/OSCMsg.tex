...
\title{INScore \\ OSC Messages Reference \\v.1.03}
...
Specific brush messages accepted by the components types \OSC{rect | ellipse | polygon | curve | line |  grid | layer}.
\begin{rail}
brushMsg : 	  'brushStyle' ('solid' | 'dense1' | 'dense2' | 'dense3' | 'dense4' | 'dense5' | 'dense6' | 'dense7' | 'none' | 'hor' | 'ver' | 'cross' | 'bdiag' | 'fdiag' | 'diagCross' | 'linearGradient' | 'radialGradient' | 'conicalGradient')
\end{rail}
...
%\begin{rail}
%brushStyle : 'solid' | 'dense1' | 'dense2' | 'dense3' | 'dense4' | 'dense5' | 'dense6' | 'dense7' | 'none' | 'hor' | 'ver' | 'cross' | 'bdiag' | 'fdiag' | 'diagCross' | 'linearGradient' | 'radialGradient' | 'conicalGradient'
%\end{rail}
...
\index{Specific messages! brushStyle! linearGradient}
\index{Specific messages! brushStyle! radialGradient}
\index{Specific messages! brushStyle! conicalGradient}
