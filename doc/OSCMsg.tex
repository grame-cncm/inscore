...
%\item \OSC{watch-}: removes messages from the watched events message list. \\
%	When no argument is provided, removes all the messages. \\
%	When an event is provided removes all the associated messages. \\
%	When an avant and an index are provided, removes the corresponding indexed message from the message list associated to the event.
\end{itemize}
