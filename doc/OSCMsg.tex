...
\index{gesture events!likelihoodThreshold}
...
\end{rail}
\index{gesture stream!send}
\index{gesture stream!active}
\index{gesture stream!idle}
...
gesturevariable : 
		...
		| 'speed') ( | '[low,high]')  
\end{rail}
\index{gesture variables!likelihood}
\index{gesture variables!pos}
\index{gesture variables!speed}
