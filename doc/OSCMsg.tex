...
\item \OSC{export} and \OSC{exportAll}: exports an object to an image file respectively without or with childrens. If the exported object is a scene, childrens are always exported.\\
...
Specific font messages accepted by the component type \OSC{txt}.
\begin{rail}
penMsg : 	  'fontSize' int32 
			| 'fontFamily' string
...
\item \OSC{fontStyle} controls the pen style.
	\begin{rail}
	...
	The font style default value is \OSC{Normal}.\\
\item \OSC{weightValue} controls the font weight.
	\begin{rail}
	...
	The font weight default value is \OSC{Normal}.
 \end{itemize}
