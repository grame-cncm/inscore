...
scoreMsg :      'page' int32
			...
			| 'columns' int32
			| 'rows' int32
			| 'get' ( 'pageCount'| 'systemCount' int32 )
\end{rail}
...
\item \OSC{systemCount}:  a read only attribute, gives the number of systems of a given score page. The page number is given as an int32 value (pages are indexes from 1).
\end{itemize}
