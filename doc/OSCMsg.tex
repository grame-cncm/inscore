...
\title{INScore \\ OSC Messages Reference \\v.1.17}
...
\item \OSC{lock}: if not null, prevent the object from being deleted. The parameter is interpreted as a boolean value. Default value is \values{0}. 
