...
%-----------------------------------------------------------------
\def\viewer{/Applications/INScore-0.72/INScoreViewer.app}
%-----------------------------------------------------------------
...
\begin{frame}
	...
	\french{Voir }\eng{See}: \\
	\begin{itemize}
	\item \href{/Applications/INScore-0.72/Max/sync/sync.maxpat}{Max/sync/sync.maxpat}
	\item \href{/Applications/INScore-0.72/PureData/sync/sync.pd}{PureData/sync/sync.pd}
	\item \href{/Applications/INScore-0.72/python/example.py}{python/example.py}
	\item \href{/Applications/INScore-0.72/lisp/example.lisp}{lisp/example.lisp}
	\end{itemize}
	\href{\viewer}{INScoreViewer} 
...
\begin{frame}
	...
	\french{Voir }\eng{See}: \\
	\begin{itemize}
	\item \href{/Applications/INScore-0.72/Max/sinus/sinus.maxpat}{Max/sinus/sinus.maxpat}
	\item \href{/Applications/INScore-0.72/PureData/sinus/sinus.pd}{PureData/sinus/sinus.pd}
	\item \href{/Applications/INScore-0.72/Max/siggraph/siggraph.maxpat}{Max/siggraph/siggraph.maxpat}
	\item \href{/Applications/INScore-0.72/PureData/siggraph/siggraph.pd}{PureData/siggraph/siggraph.pd}
	\end{itemize}
