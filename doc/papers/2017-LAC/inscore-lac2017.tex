...
\author
{Dominique Fober \and Yann Orlarey \and Stéphane Letz
\\ GRAME - Centre national de création musicale 
\\ 11 cous de Verdun Gensoul
\\ 69002 Lyon
\\ France, 
...
\begin{abstract}
\begin{contentsmall}
INScore is an environment for the design of augmented interactive music scores opened to conventional and non-conventional use of the music notation. The system has been presented at LAC 2012 and has significantly evolved since. This paper presents the latest features and notably the dynamic time model, the events system, the scripting language, the symbolic scores composition engine, the network and web extensions, the interaction processes representation system and the set of sensor objects.
\end{contentsmall}
\end{abstract}
...
Contemporary music creation poses numerous challenges to the music notation. Spatialised music, new instruments, gesture based interactions, real-time and interactive scores, are among the new domains that are now commonly explored by the artists. 
...
Issues like writing spatialised music \cite{Ellberger_tenor2015}, addressing new instruments \cite{tmays:2014} or new interfaces \cite{kschlei:2015} (to cite just a few), are now subject of active research and proposals.
...
\tab \OSC{score->color(255 128 40 150)}
