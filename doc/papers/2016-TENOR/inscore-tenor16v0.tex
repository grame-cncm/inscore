...
\begin{itemize}
\item a GMN file evaluation returns its content,
\item a MusicXML file evaluation returns its content,
\item an object identifier evaluation gives its GMN code,
\item a GMN string evaluation returns the string,
\item a MusicXML string evaluation converts the string to GMN code,
...
This evaluation scheme avoid recusion issues (e.g. a score that modifies itself using an expression based on its content)
