...
%type <str>		identifier oscaddress oscbase msgstring comment commented
%type <msg>		message
%type <p>		param
%type <plist>	params
...
//_______________________________________________
ITLfile		: message			{ cout << $1 << ";" << endl; delete $1; }
			| comment			{ cout << *$1; delete $1; }
			| ITLfile message	{ cout << $2 << ";" << endl; delete $2; }
			| ITLfile comment	{ cout << *$2; delete $2; }
			;

//_______________________________________________
comment		: commented				{ $$ = $1; }
			| commented ENDCOMMENT	{ *$1 += ITLtext; $$ = $1; }
			;

commented	: COMMENTTEXT			{ $$ = new string(ITLtext); }
			| commented COMMENTTEXT	{ *$1 += ITLtext; $$ = $1; }
			;
