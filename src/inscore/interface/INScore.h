...
//	static void timeTask (IGlue* glue);
	...
	*/
	...
	static float version()				{ return 1.22f; }	///< gives the library version number
	static const char* versionStr()		{ return "1.22"; }	///< gives the library version number as a string
