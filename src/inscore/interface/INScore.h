...
//	static void timeTask (IGlue* glue);
	...
	*/
	...
	static float version()				{ return 1.20f; }	///< gives the library version number
	static const char* versionStr()		{ return "1.20"; }	///< gives the library version number as a string
