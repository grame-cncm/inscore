...
class inscore_export INScore
{
	...
	*/
	...
	static float version()					{ return 1.27f; }	///< gives the library version number
	static std::string versionStr()	{ return "1.27"; }	///< gives the library version number as a string
