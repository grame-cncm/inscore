...
void HtmlColor::init() 
{
	...
	fColorsMap["mediumpurple"]		= 0x9370db;
	...
	fColorsMap["palevioletred"]		= 0xdb7093;
	...
	fColorsMap["rebeccapurple"]		= 0x663399;
