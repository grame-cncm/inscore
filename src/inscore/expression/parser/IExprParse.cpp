...
#define yylval  IExprlval
#define yychar  IExprchar
#define yydebug IExprdebug
#define yynerrs IExprnerrs
#define yylloc IExprlloc
...
#ifdef WIN32
#pragma warning (disable : 4267 4065 4100 4005)
#endif
...
{
       0,     0,     3,     5,     7,     9,    11,    13,    16,    22,
      26,    31,    33,    35,    37,    40,    43,    45,    47
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      12,     0,    -1,    16,    -1,    10,    -1,    13,    -1,     9,
      -1,     8,    -1,     5,    13,    -1,     3,    17,    18,    18,
       4,    -1,     3,    18,     4,    -1,     3,    17,    15,     4,
      -1,    13,    -1,    15,    -1,    19,    -1,     6,    19,    -1,
       7,    19,    -1,    16,    -1,    14,    -1,    15,    -1
};
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, inscore::IExprParser* context)
#else
static void
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (inscore::IExprParser* context);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
#line 104 "IExpr.y"
    { CHECKVAR((yyvsp[(3) - (4)].strList), 2) (yyval.argbase) = new inscore::SIExprArg( inscore::ExprFactory::createExpr(*(yyvsp[(2) - (4)].str),
																														...
																														inscore::ExprFactory::createArg( (yyvsp[(3) - (4)].strList)->at(1) ))); delete (yyvsp[(2) - (4)].str); delete (yyvsp[(3) - (4)].strList);;}
    break;
