...
#define yyparse itlmapparse
#define yylex   itlmaplex
#define yyerror itlmaperror
#define yylval  itlmaplval
#define yychar  itlmapchar
#define yydebug itlmapdebug
#define yynerrs itlmapnerrs
...
{
  "$end", "error", "$undefined", "NUMBER", "FLOAT", "SEGSTART", "SEGEND",
  "INTERVAL", "RATIONALBAR", "SEP", "ERROR", "$accept", "mapping",
  "timeSegment", "_2Dint2timemap", "_2Dint2timeRelation", "_2DintSegment",
  "intInterval", "_1Dint2timemap", "_1Dint2timeRelation", "intSegment",
  "_1Dfloat2timemap", "_1Dfloat2timeRelation", "_1DfloatSegment",
  "floatInterval", "_2Dfloat2timemap", "_2Dfloat2timeRelation",
  "_2DfloatSegment", "rational", "number", "floatnumber", 0
};
#endif
