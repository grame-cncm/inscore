...
class IBrushStyle {
    ...
    static brushStyleStr2Num(str: string): { correct: boolean, val: number } {
        switch (str) {
        	case "solid": 	return { correct: true, val: brushStyle.solid }
        	case "none": 	return { correct: true, val: brushStyle.none }
        } 
    ...
    static brushStyleNum2Str(n: number): { correct: boolean, val: string } {
        switch (n) {
        	case brushStyle.solid: 	return { correct: true, val: "solid" }
        	case brushStyle.none: 	return { correct: true, val: "none" }
        } 
