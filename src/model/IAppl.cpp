...
//	fMsgHandlerMap["activate"]					= TMethodMsgHandler<IAppl, void (IAppl::*)() const>::create(this, &IAppl::activate);
	...
	fGetMsgHandlerMap[krootPath_GetSetMethod]	= TGetParamMsgHandler<const string&>::create(fRootPath);
	...
	fGetMsgHandlerMap[kversion_GetMethod]		= TGetParamMsgHandler<const string&>::create(fVersion);
