...
the INScore Viewer. Only Lispworks is currently supported.
...
See at http://www.cliki.net/lispworks-udp for more information 
and for the latest release.

The glue between 'cl-osc' and 'lispworks-udp' is provided by 'oscoverudp.lisp',
which is based on the IRCAM Open Music osc support.

You should evaluate the file 'example.lisp' while INScore Viewer is running.
