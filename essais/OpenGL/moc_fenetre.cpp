...
**
** Created: Tue May 31 10:47:38 2011
...
const QMetaObject fenetre::staticMetaObject = {
    { &widgetOpenGL::staticMetaObject, qt_meta_stringdata_fenetre,
...
void *fenetre::qt_metacast(const char *_clname)
{
    ...
    return widgetOpenGL::qt_metacast(_clname);
}

int fenetre::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = widgetOpenGL::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
