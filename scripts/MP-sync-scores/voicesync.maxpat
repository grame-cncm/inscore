{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 69.0, 260.0, 206.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 69.0, 260.0, 206.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.0, 376.0, 163.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 319.0, 155.0, 18.0 ],
					"text" : "/ITL load voicesync.inscore"
				}
