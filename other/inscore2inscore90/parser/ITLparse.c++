...
#define ERROR 267
#define ENDMSG 268
#define COMMENTTEXT 269
#define ENDCOMMENT 270
...
static const yytype_uint8 yyprhs[] =
{
      ...
      23,    26,    30,    32,    35,    38,    40,    42,    44,    46,
      48,    50,    51,    53,    56,    58,    60,    62,    64
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      17,     0,    -1,    20,    -1,    18,    -1,    17,    20,    -1,
      17,    18,    -1,    19,    -1,    19,    15,    -1,    14,    -1,
      19,    14,    -1,    21,    25,    -1,    21,    24,    25,    -1,
      22,    -1,    21,    22,    -1,     8,    23,    -1,     5,    -1,
       7,    -1,    11,    -1,     5,    -1,     7,    -1,     6,    -1,
      -1,    26,    -1,    25,    26,    -1,     3,    -1,     4,    -1,
      10,    -1,     5,    -1,     6,    -1
};
...
{
       0,    71,    71,    72,    73,    74,    78,    79,    82,    83,
      87,    88,    93,    94,    97,   100,   101,   104,   105,   106,
     107,   110,   111,   112,   115,   116,   117,   118,   119
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MAPIDENTIFIER", "REGEXP", "PATHSEP", "WINSEP", "STRING", "MSG", "ERROR",
  "ENDMSG", "COMMENTTEXT", "ENDCOMMENT", "$accept", "ITLfile", "comment",
  "commented", "message", "oscaddress", "oscbase", "identifier",
  "msgstring", "params", "param", 0
};
#endif
...
{
       0,     0,     8,     0,     3,     6,     2,    21,    12,    15,
      16,    14,     1,     5,     4,     9,     7,    24,    25,    18,
      20,    19,    26,    17,    13,    21,    10,    22,    27,    28,
      11,    23
};
...
{
       5,    16,    -7,     0,    -7,    -3,    -7,    -1,    -7,    -7,
      -7,    -7,    -7,    -7,    -7,    -7,    -7,    -7,    -7,    -7,
      -7,    -7,    -7,    -7,    -7,    12,    12,    -7,    -7,    -7,
      12,    -7
};
...
{
      12,    13,    17,    18,    19,    20,    21,     1,     1,    22,
      23,    15,    16,     1,     2,    17,    18,    28,    29,     2,
      31,     9,    22,    10,    31,    14,    24,    30
};

static const yytype_uint8 yycheck[] =
{
       0,     3,     3,     4,     5,     6,     7,     8,     8,    10,
      11,    14,    15,     8,    14,     3,     4,     5,     6,    14,
      26,     5,    10,     7,    30,     3,     7,    25
};
...
{
       0,     8,    14,    17,    18,    19,    20,    21,    22,     5,
       7,    23,     0,    18,    20,    14,    15,     3,     4,     5,
       6,     7,    10,    11,    22,    24,    25,    26,     5,     6,
      25,    26
};
  ...
  switch (yyn)
    {
        case 2:
#line 71 "ITL.y"
    { cout << (yyvsp[(1) - (1)].msg) << ";" << endl; delete (yyvsp[(1) - (1)].msg); ;}
    break;

  case 3:
#line 72 "ITL.y"
    { cout << *(yyvsp[(1) - (1)].str); delete (yyvsp[(1) - (1)].str); ;}
    break;

  case 4:
#line 73 "ITL.y"
    { cout << (yyvsp[(2) - (2)].msg) << ";" << endl; delete (yyvsp[(2) - (2)].msg); ;}
    break;

  case 5:
#line 74 "ITL.y"
    { cout << *(yyvsp[(2) - (2)].str); delete (yyvsp[(2) - (2)].str); ;}
    break;
...
#line 78 "ITL.y"
  ...
  case 7:
#line 79 "ITL.y"
    { *(yyvsp[(1) - (2)].str) += ITLtext; (yyval.str) = (yyvsp[(1) - (2)].str); ;}
    break;
